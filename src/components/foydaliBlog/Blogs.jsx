                    ...
                    <div className="blogs__section">
                        <div className="blogs___right">
                            ...
                            <div className="blogs__right-info">
                                <h3 className="blogs__right-title">"Bugungi kunda oziq-ovqat xavfsizligi butun dunyoda eng dolzarb muammoga aylanib bormoqda."</h3>
                                <p className="blogs__right-text">Issiqxonalar aholi bandligini ta’minlash va mahsulot eksport qilishning katta manbai. Issiqxonalarni ko‘paytirish uchun tadbirkorlarning keng doirasini qiziqtirish, ularga har tomonlama yordam berish zarur.</p>
                                <h3 className="blogs__right-name">Sh.Mirziyoyev</h3>
                            </div>
                        </div>
                        ...
                        <div className="blogs__left">
                            ...
                            <div className="blogs__left-info">
                                ...
                                <Link className="blogs__info-link" to="/more">Ko'proq ma'lumot</Link>
                            </div>
                            <div className="blogs__left-info">
                            ...
                            <div className="blogs__left-info">
                                ...
                                <div className="blogs__left-links">
                                    <Link className="blogs__info-link" to="/more">Ko'proq ma'lumot</Link>
                                    <Link className="blogs__info-more" to="/more">Ko'proq</Link>
                                </div>
                            </div>
                        </div>
                    </div>
